...
private fun OTPConfirmationScreenComposable(
    ...
    val resendCode = AnnotatedString(
    ...
    Column(modifier = Modifier.padding(bottom = 32.dp)) {
        ...
        BodyText(
            text = stringResource(id = R.string.passcode_sent_to, recipientFormatted)
        )
        Text(
            text = stringResource(id = R.string.code_expires_in, 1234, resendCode),
            textAlign = TextAlign.Start,
            ...
            AlertDialog(
                ...
                Surface(
                    ...
                    Column(modifier = Modifier.padding(24.dp)) {
                        ...
                        Body2Text(
                            text = stringResource(id = R.string.new_code_will_be_sent_to, recipientFormatted),
                            color = Color(theme.dialogTextColor)
                        )
                    }
                }
