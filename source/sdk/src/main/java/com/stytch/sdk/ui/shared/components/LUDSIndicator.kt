    ...
    Column(
        ...
        Row {
            ...
            Text(
                text =
                    stringResource(
                        id = R.string.stytch_feedback_luds_missing_characters_message,
        ...
        Row {
            ...
            Text(
                text =
                    stringResource(
                        id = R.string.stytch_feedback_luds_missing_complexity_message,
        ...
        if (breached) {
            Row {
                ...
                Text(
                    text = stringResource(id = R.string.stytch_feedback_luds_breached_password_warning),
                    style =
                        type.caption.copy(
