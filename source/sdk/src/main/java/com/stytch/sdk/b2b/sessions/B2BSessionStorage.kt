...
internal class B2BSessionStorage(
    ...
    fun updateSession(
        ...
        synchronized(this) {
            this.sessionToken = if (intermediateSessionToken.isNullOrBlank()) sessionToken else null
            this.sessionJwt = if (intermediateSessionToken.isNullOrBlank()) sessionJwt else null
