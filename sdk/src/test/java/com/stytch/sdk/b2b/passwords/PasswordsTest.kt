...
internal class PasswordsTest {
    ...
    fun `Passwords ResetByExistingPasswordParameters have correct default values`() {
        val params = Passwords.ResetByExistingPasswordParameters(
            organizationId = "organizationId",
            emailAddress = "emailAddress",
            existingPassword = "existingPassword",
            newPassword = "newPassword"
        )
        val expected = Passwords.ResetByExistingPasswordParameters(
            organizationId = "organizationId",
            emailAddress = "emailAddress",
            existingPassword = "existingPassword",
            newPassword = "newPassword",
    ...
    fun `Passwords StrengthCheckParameters have correct default values`() {
        val params = Passwords.StrengthCheckParameters(
            password = "password",
        )
        val expected = Passwords.StrengthCheckParameters(
            email = null,
            password = "password",
        )
        assert(params == expected)
